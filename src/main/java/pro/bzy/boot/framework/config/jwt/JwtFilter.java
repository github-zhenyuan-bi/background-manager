...
public class JwtFilter extends AccessControlFilter {
    ...
    protected boolean onAccessDenied(ServletRequest servletRequest, ServletResponse servletResponse) throws Exception {
        ...
        try {
            ...
            if (!is_legal_access_token) 
                throw new JwtException(JWT_constant.JWT_ACCESS_TOKEN_KEY+"校验失败, 无法获取认证");
    ...
    private void checkUserIp(String access_token, HttpServletRequest httpRequest) {
        ...
        Object access_token_ip = JwtUtil.BASE_UTIL.decode(access_token).get(JWT_constant.JWT_LOGIN_USER_IP_KEY);
    ...
    private void setUserDetailToRequestForRenderView(String access_token, 
        ...
        try {
            ...
            httpRequest.setAttribute(JWT_constant.JWT_BASESTORAGE_DATAS_KEY, baseDatas);
        } catch (Exception e) {
