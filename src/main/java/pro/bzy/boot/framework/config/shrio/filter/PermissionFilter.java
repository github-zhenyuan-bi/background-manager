...
public class PermissionFilter extends PermissionsAuthorizationFilter {
    ...
    public boolean isAccessAllowed(ServletRequest request, ServletResponse response, Object mappedValue)
        ...
        try {
            ...
            permDatas = getPermsData(access_token, userDatas);
            ...
            try {
                handleUnAuthor(httpRequest, httpResponse, e.getMessage());
            } catch (Exception e1) {
    ...
    private List<String> getPermsData(final String access_token, final Map<String, Object> userDatas) {
    ...
    private void handleUnAuthor(HttpServletRequest httpRequest, HttpServletResponse httpResponse, String msg) throws Exception {
