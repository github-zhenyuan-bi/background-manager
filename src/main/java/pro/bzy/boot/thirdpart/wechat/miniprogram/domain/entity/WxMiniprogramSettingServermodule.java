...
@ApiModel(value="WxMiniprogramSettingServermodule", description="")
public class WxMiniprogramSettingServermodule extends Model<WxMiniprogramSettingServermodule> {
	...
	*/
    ...
    @ApiModelProperty(value = "服务名称", position = 10)
    private String name;
    
    
    
    @ApiModelProperty(value = "服务图片地址", position = 15)
    private String icon;
    
    
    
    @ApiModelProperty(value = "服务地址", position = 20)
    private String serverUrl;
    
    
    
    @ApiModelProperty(value = "服务排序", position = 25)
    private Integer sort;
    
    
    
    @ApiModelProperty(value = "服务可用", position = 30)
    ...
    @ApiModelProperty(value = "逻辑删除", position = 45)
    @TableField(fill = FieldFill.INSERT)
